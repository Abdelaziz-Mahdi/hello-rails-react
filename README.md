...
**Hello React Rails App** Generate random greatings - Webpack with bundling-rails gem.
...
Feel free to check the [issues page](https://github.com/Abdelaziz-Mahdi/hello-rails-react/issues).
